...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/dashboard/locations", labelKey: "locations",
  ...
  },
  {
    ...
    items: [
      {
        href: "/dashboard/reminders", labelKey: "reminders",
