        ...
        <div style={{ background: "#0b0b16", border: "1px solid rgba(119,104,212,0.1)", borderRadius: 14, padding: "18px 20px", position: "relative", zIndex: 1, marginTop: 32 }}>
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#7768d4", display: "grid", placeItems: "center", fontFamily: "var(--font-heading, Outfit, sans-serif)", fontSize: 12, fontWeight: 700, color: "#fff" }}>{t("testimonialInitials")}</div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 600 }}>{t("testimonialName")}</div>
                <div style={{ fontSize: 12, color: "#3a3a58" }}>{t("testimonialRole")}</div>
              </div>
            </div>
          </>
        </div>
